<%@ Page Title="Station Line" Language="C#" MasterPageFile="~/MyMaster.Master" AutoEventWireup="true" CodeBehind="Customer.aspx.cs" Inherits="FATMSYSTEM.Customer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <button type="button" id="btnNew" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModalNew" title="Create new Customer">
                New
            </button>
    ...
    <asp:GridView ID="gvList" runat="server" Font-Size="12px" CssClass="table table-striped pagination-ys" AutoGenerateColumns="False" GridLines="Horizontal" Width="100%" OnRowCommand="gvList_RowCommand" OnPageIndexChanging="gvList_PageIndexChanging" PageSize="12" AllowPaging="True" ShowHeaderWhenEmpty="True" EmptyDataText="No records Found">
        <Columns>
            ...
            <asp:BoundField DataField="Cust_Nm" HeaderText="Cust_Nm" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>
                            Description</label>
                        <asp:TextBox ID="txtCust_Nm" runat="server" class="form-control input-sm"></asp:TextBox>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <label>
                            Description</label>
                        <asp:TextBox ID="txtCust_Nm_" runat="server" class="form-control input-sm"></asp:TextBox>
    ...
    <script type="text/jscript">
        ...
        $(document).ready(function () {
            $('#btnNew').click(function () {
                document.getElementById("<%=txtCust_Nm.ClientID%>").value = "";
            });
        })
        ...
        function validate_new() {
            ...
            if (document.getElementById("<%=txtCust_Nm.ClientID%>").value == "") {
        ...
        function validate_update() {
            ...
            if (document.getElementById("<%=txtCust_Nm_.ClientID%>").value == "") {
