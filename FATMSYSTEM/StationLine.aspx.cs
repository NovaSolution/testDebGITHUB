...
{
    public partial class StationLine : System.Web.UI.Page
    {
        Helper hp = new Helper();
        cStationLine IC = new cStationLine();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            IC.vUID = Session["uid"].ToString();
            IC.vNAME = txtDescription.Text.ToString();
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                IC.vUID = Session["uid"].ToString();
                IC.vNAME = txtDescription_.Text.ToString();
        ...
        private void ExportGridToExcel()
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=StationLineification.xls");
